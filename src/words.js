const words = [
    ...
    { word: "as", sentence: "Her role as an English teacher is very important."},
    ...
    { word: "year", sentence: "This is the year I'm finally going to learn English."},
    ...
    { word: "some", sentence: "Please give them some of the apples I brought home."},
    ...
    { word: "than", sentence: "I like this cake better than the other one you showed me."},
    { word: "like", sentence: "I like this bag better than the other one you showed me."},
    { word: "other", sentence: "I like these shoes better than the other ones you showed me."},
    ...
    { word: "through", sentence: "Your faith will see you through tough times."},
    { word: "us", sentence: "Do you want to go with us?"},
    { word: "life", sentence: "This is the best day of my life."},
    { word: "child", sentence: "I just saw a child cross the street by herself."},
    ...
    { word: "as", sentence: "As soon as I get home, I'm going to start watching that series."},
    ...
    { word: "feel", sentence: "I feel so tired, I just need to relax and unwind."},
    { word: "three", sentence: "I have three sisters."},
    { word: "when", sentence: "When was the last time you saw them?"},
    { word: "state", sentence: "Check out the state of that shed, it's falling apart."},
    ...
    { word: "great", sentence: "This ice cream place is great for families with kids!"},
    { word: "same", sentence: "Hey, we're wearing the same shirt!"},
    { word: "big", sentence: "I have this big crush on Brad Pitt."},
    { word: "group", sentence: "The group sitting across our table is so noisy."},
    { word: "begin", sentence: "Where do I begin with this huge project?"},
    { word: "seem", sentence: "She may seem quiet, but she's really outgoing once you get to know her."},
    ...
    { word: "problem", sentence: "The problem is we think we have plenty of time."},
    { word: "every", sentence: "Every person has his own big goal to fulfill."},
    { word: "start", sentence: "This is a great to start to learn the English language."},
    ...
    { word: "show", sentence: "Can you show me how to use this vacuum cleaner?"},
    ...
    { word: "case", sentence: "What an interesting case you are working on now!"},
    { word: "most", sentence: "That's the most interesting story I've ever heard."},
    ...
    { word: "program", sentence: "This community program for teens is really helpful."},
    ...
    { word: "government", sentence: "I hope the government does something about the poverty in this country."},
    ...
    { word: "happen", sentence: "What will happen if you don't submit your report on time?"},
    ...
    { word: "large", sentence: "There's a large amount of data online about that topic."},
    { word: "all", sentence: "That's all I know about Dinosaurs."},
    { word: "million", sentence: "I have a million questions about this book."},
    ...
    { word: "different", sentence: "Just because she's different, it doesn't mean she's bad."},
    ...
    { word: "though", sentence: "Though you are angry now, I'm sure you will forget about this later."},
    ...
    { word: "after", sentence: "After all this time, he has finally learned to love."},
    { word: "since", sentence: "Ever since his mom died, he has been cranky and angry at the world."},
    { word: "long", sentence: "That was such a long time ago."},
    { word: "provide", sentence: "Please provide me with a list of your services."},
    { word: "service", sentence: "Do you have a specific dental service to treat this?"},
    ...
    { word: "hour", sentence: "I've been checking his temperature every hour."},
    ...
    { word: "however", sentence: "I want to buy this bag, however, I need to save up for it first."},
    ...
    { word: "include", sentence: "Did you remember to include the summary in your report?"},
    ...
    { word: "much", sentence: "There's so much to learn in the English language."},
    { word: "name", sentence: "What's your name?"},
    { word: "five", sentence: "I can give you five reasons why you need to watch that video."},
    { word: "once", sentence: "I once had a puppy named Bark."},
    { word: "white", sentence: "I love my white sneakers."},
    { word: "least", sentence: "She's the least productive among all the employees."},
    { word: "president ", sentence: "She was our class president back in high school."},
    { word: "learn", sentence: "I'd love to learn more about the English language."},
    { word: "real", sentence: "What is her real name?"},
    { word: "change", sentence: "What can we change so that things will get better?"},
    { word: "team", sentence: "They hired a team to do the design of their new office."},
    { word: "minute", sentence: "She's laughing every minute of every day."},
    { word: "best", sentence: "This is the best potato salad I've ever tasted."},
    { word: "several", sentence: "I have several old clothes I need to donate."},
    { word: "idea", sentence: "It was your idea to go to the beach, remember?"},
    ...
    { word: "nothing", sentence: "There's nothing we can do now. "},
    { word: "ago", sentence: "Three years ago, I visited Japan for the first time."},
    ...
    { word: "whether", sentence: "Whether in big groups or small groups, I always feel a little shy at first."},
    { word: "back", sentence: "Looking back, I knew I was always an introvert."},
    ...
    { word: "parent", sentence: "Every parent is trying hard and doing their best."},
    ...
    { word: "create", sentence: "Did you create that presentation? It was so good."},
    ...
    { word: "allow", sentence: "Do you allow your kids to play outside the house?"},
    { word: "add", sentence: "Is it okay if we add a bit of sugar to the tea?"},
    { word: "office", sentence: "Welcome to my office."},
    { word: "spend", sentence: "How much did you spend on your last shopping spree?"},
    ...
    { word: "within", sentence: "We support everyone within our small community."},
    { word: "grow", sentence: "We want everyone to grow and thrive in their careers."},
    { word: "result", sentence: "The result of this outreach program is amazing."},
    ...
    { word: "moment", sentence: "The moment she walked in the room, her puppy started to jump and dance again."},
    ...
    { word: "both", sentence: "You both need to change into your sleep clothes now."},
    { word: "education", sentence: "I just want you to get the best education."},
    { word: "across", sentence: "Your dog ran across the park."},
    { word: "although", sentence: "Although she felt tired, she still couldn't sleep."},
    { word: "remember", sentence: "Do you think she will still remember me after ten years?"},
    { word: "foot", sentence: "Her foot got caught in one of the ropes."},
    { word: "second", sentence: "This is the second time she got late this month."},
    { word: "boy", sentence: "There's a boy in her class who keeps pulling her hair."},
    { word: "maybe", sentence: "Maybe we can have ice cream for dessert."},
    { word: "toward", sentence: "He took a step toward her."},
    { word: "able", sentence: "Will you be able to send me your report today?"},
    ...
    { word: "process", sentence: "Wait, give me time to process everything you're telling me."},
    { word: "music", sentence: "I love music."},
    { word: "including", sentence: "Around 20 people attended, including Bob and Beth."},
    ...
    { word: "serve", sentence: "This blow dryer has served me well for years."},
    { word: "market", sentence: "Let's visit the Sunday market."},
    { word: "die", sentence: "I don't want my cat to die, let's take him to the vet please."},
    { word: "send", sentence: "Please send the package to my address."},
    { word: "expect", sentence: "You can't expect much from their poor service."},
    ...
    { word: "behind", sentence: "I'm scared to check what's behind that door."},
    { word: "reach", sentence: "I can't reach him, he won't answer his phone."},
    ...
    { word: "raise", sentence: "It's so challenging to discipline kids these days."},
    ...
    { word: "late", sentence: "I am running late for my doctor's appointment."},
    ...
    { word: "sometimes", sentence: "Sometimes I forget to turn off the porch lights."},
    { word: "require", sentence: "They'll require you to show your I.D."},
    { word: "along", sentence: "Can I tag along your road trip?"},
    { word: "development", sentence: "This news development is really interesting."},
    ...
    { word: "economic", sentence: "Some countries are facing an economic crisis."},
    { word: "effort", sentence: "The government must make an effort to solve this."},
    ...
    { word: "possible", sentence: "Maybe it's possible to change their bathroom amenities."},
    { word: "heart", sentence: "My heart is so full."},
    { word: "drug", sentence: "She got the patent for the drug she has created to cure cancer."},
    { word: "show", sentence: "Can you show me how to solve this puzzle?"},
    { word: "leader", sentence: "You are a wonderful leader."},
    { word: "light", sentence: "Watch her face light up when you mention his name."},
    { word: "voice", sentence: "Hearing his mom's voice is all he need right now."},
    { word: "wife", sentence: "My wife is away for the weekend."},
    { word: "whole", sentence: "I have the whole house to myself."},
    { word: "police", sentence: "The police have questioned him about the incident."},
    { word: "mind", sentence: "This relaxation technique really eases my mind."},
    { word: "finally", sentence: "I can finally move out from my old apartment."},
    ...
    { word: "less", sentence: "I am praying for less stress this coming new year."},
    { word: "according", sentence: "According to the weather report, it's going to rain today."},
    ...
    { word: "even", sentence: "Even if they've broken up, they still remain friends."},
    { word: "develop", sentence: "That rash could develop into something more serious."},
    { word: "view", sentence: "This view is amazing!"},
    { word: "relationship", sentence: "They've taken their relationship to the next level."},
    { word: "carry", sentence: "Can you carry my bag for me?"},
    { word: "town", sentence: "This town is extremely quiet."},
    { word: "road", sentence: "There's a road that leads to the edge of the woods."},
    ...
    { word: "difference", sentence: "What's the difference between happiness and contentment?"},
    { word: "thank", sentence: "I forgot to thank her for the pie she sent us."},
